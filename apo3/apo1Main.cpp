...
apo1Frame::apo1Frame(wxWindow* parent,wxWindowID id)
{
    ...
    StaticBoxSizer4 = new wxStaticBoxSizer(wxHORIZONTAL, Panel1, _("Zadanie 1"));
    GridSizer1 = new wxGridSizer(0, 2, 0, 0);
    wyostrzanie1 = new wxCheckBox(Panel1, ID_CHECKBOX1, _("Wyostrzanie 1"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
    wyostrzanie1->SetValue(false);
    GridSizer1->Add(wyostrzanie1, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    metoda2 = new wxCheckBox(Panel1, ID_CHECKBOX2, _("Wyostrzanie 2"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX2"));
    metoda2->SetValue(false);
    GridSizer1->Add(metoda2, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    metoda3 = new wxCheckBox(Panel1, ID_CHECKBOX4, _("Detekcja 1"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX4"));
    metoda3->SetValue(false);
    GridSizer1->Add(metoda3, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    wlasna = new wxCheckBox(Panel1, ID_CHECKBOX3, _("Detekcja 2"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX3"));
    ...
    StaticBoxSizer3->Add(Button2, 1, wxALL|wxSHAPED|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
void apo1Frame::OnButton2Click(wxCommandEvent& event)
{
    if (loaded)
    {
        if (wyostrzanie1->IsChecked())
        {
            Image_show *okno=new Image_show(FileDialog1->GetPath(), obraz, _("Wyostrzanie 1"),1);
            okno->Show();
        }
