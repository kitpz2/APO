...
apo1Frame::apo1Frame(wxWindow* parent,wxWindowID id)
{
    ...
    metoda1 = new wxCheckBox(Panel1, ID_CHECKBOX1, _("Negacja"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
    metoda1->SetValue(false);
    GridSizer1->Add(metoda1, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    metoda2 = new wxCheckBox(Panel1, ID_CHECKBOX2, _("Progowanie"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX2"));
    metoda2->SetValue(false);
    GridSizer1->Add(metoda2, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    metoda3 = new wxCheckBox(Panel1, ID_CHECKBOX4, _("Redukcja poziomów szarości"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX4"));
    metoda3->SetValue(false);
    GridSizer1->Add(metoda3, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    metoda4 = new wxCheckBox(Panel1, ID_CHECKBOX3, _("rozciaganie"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX3"));
    metoda4->SetValue(false);
    GridSizer1->Add(metoda4, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    metoda5 = new wxCheckBox(Panel1, ID_CHECKBOX6, _("Redukcja Kontrastem"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX6"));
    metoda5->SetValue(false);
    GridSizer1->Add(metoda5, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    metoda6 = new wxCheckBox(Panel1, ID_CHECKBOX7, _("Regulacja jasnością"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX7"));
    metoda6->SetValue(false);
    GridSizer1->Add(metoda6, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    metoda7 = new wxCheckBox(Panel1, ID_CHECKBOX5, _("Korakcja Gamma"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX5"));
    metoda7->SetValue(false);
    GridSizer1->Add(metoda7, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
    StaticBoxSizer2->Add(GridSizer1, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
...
void apo1Frame::OnButton2Click(wxCommandEvent& event)
{
    if (loaded)
    {
        ...
        {
            Image_show *okno=new Image_show(FileDialog1->GetPath(), obraz, _("Negacja"),1);
            okno->Show();
        }
        if (metoda2->IsChecked())
        {
            Image_show *okno=new Image_show(FileDialog1->GetPath(), obraz, _("Progowanie"),2);
            okno->Show();
        }
        if (metoda3->IsChecked())
        {
            Image_show *okno=new Image_show(FileDialog1->GetPath(), obraz, _("redukcja poziomow szarosci"),3);
            okno->Show();
        }
        if (metoda4->IsChecked())
        {
            Image_show *okno=new Image_show(FileDialog1->GetPath(), obraz, _("rozciąganie"),4);
            okno->Show();
        }
        if (metoda5->IsChecked())
        {
            Image_show *okno=new Image_show(FileDialog1->GetPath(), obraz, _("regulacja kontrastem"), 5);
            okno->Show();
        }
        if (metoda6->IsChecked())
        {
            Image_show *okno=new Image_show(FileDialog1->GetPath(), obraz, _("regulacja jasnościa"), 6);
            okno->Show();
        }
        if (metoda7->IsChecked())
        {
            Image_show *okno=new Image_show(FileDialog1->GetPath(), obraz, _("korekcja gamma"), 7);
            okno->Show();
        }
    }
    else
